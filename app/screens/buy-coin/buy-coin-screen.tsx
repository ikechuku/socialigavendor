...
export const BuyCoinScreen: FC<StackScreenProps<NavigatorParamList>> = observer(
  ({ navigation }) => {
    ...
    return (
      ...
      >
        <View testID="BuyCoinScreen" style={FULL}>
          <GradientBackground
          ...
          >
            <View style={BOTTOM}>
              ...
              <View style={[ROOT, { marginVertical: 10, marginTop: 50 }]}>
                ...
                <Text style={TITLE} preset="header" text="Buy coin" />
              </View>
              <View style={SEARCH}>
