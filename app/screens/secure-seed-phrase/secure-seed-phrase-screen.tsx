...
export const SecureSeedPhraseScreen: FC<
  StackScreenProps<NavigatorParamList, "SecureSeedPhraseScreen">
> = observer(({ navigation }) => {
  const NextScreen = () => navigation.navigate("WriteSeedPhraseScreen");
  const goBack = () => navigation.goBack();

  const [important, setImportant] = useState(false);

  return (
    <View testID="SecureSeedPhraseScreen" style={FULL}>
      <GradientBackground
