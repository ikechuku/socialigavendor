...
export const SwapCoinScreen: FC<StackScreenProps<NavigatorParamList>> =
  observer(({ navigation }) => {
    const goBack = () => navigation.goBack();
    const details = () => navigation.navigate("HighNetworkScreen");
    ...
    return (
      ...
      >
        <View testID="SwapCoinScreen" style={FULL}>
          <GradientBackground
          ...
          >
            <View style={BOTTOM}>
              ...
              <View style={[ROOT, { marginVertical: 10, marginTop: 50 }]}>
                ...
                <Text style={TITLE} preset="header" text="Swap To" />
              </View>
              <View style={SEARCH}>
