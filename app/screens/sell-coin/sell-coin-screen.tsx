...
export const SellCoinScreen: FC<StackScreenProps<NavigatorParamList>> =
  observer(({ navigation }) => {
    const goBack = () => navigation.goBack();
    const [currency, setCurrency] = useState("NGN");
    const details = () => navigation.navigate("CoinDetailsScreen");
    ...
    return (
      ...
      >
        <View testID="SellCoinScreen" style={FULL}>
          <GradientBackground
          ...
          >
            <View style={BOTTOM}>
              ...
              <View style={[ROOT, { marginVertical: 10, marginTop: 50 }]}>
                ...
                <Text style={TITLE} preset="header" text="Sell coin" />
              </View>
              <View style={SEARCH}>
