...
export const ReceiveBTCScreen: FC<StackScreenProps<NavigatorParamList>> =
  observer(({ navigation }) => {
    const goBack = () => navigation.goBack();
    const details = () => navigation.navigate("PaymentOptionsScreen");
    ...
    return (
      ...
      >
        <View testID="ReceiveBTCScreen" style={FULL}>
          <GradientBackground
              ...
              >
                ...
                >
                  <Text style={COINT_ITEM}>
                    Scan the QR code to get address
                  </Text>
                  ...
                  <Icon
                    ...
                    icon="qr"
                  />
                  <Text style={COINT_ITEM}>Private Key</Text>
                </View>
              </TouchableOpacity>
